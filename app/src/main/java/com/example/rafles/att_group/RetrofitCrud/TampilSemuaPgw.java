    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String address = jo.getString(Konfigurasi.TAG_ADDRESS);

                HashMap<String,String> employees = new HashMap<>();
                employees.put(Konfigurasi.TAG_ID,id);
                employees.put(Konfigurasi.TAG_NAMA,name);
                employees.put(Konfigurasi.TAG_ADDRESS,address);
                list.add(employees);
            }
        ...
        ListAdapter adapter = new SimpleAdapter(
                ...
                new String[]{Konfigurasi.TAG_ID,Konfigurasi.TAG_NAMA,Konfigurasi.TAG_ADDRESS},
