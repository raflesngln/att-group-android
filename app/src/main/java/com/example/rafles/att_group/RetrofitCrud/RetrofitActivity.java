...
class AddEmployee extends AsyncTask<Void,Void,String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        loading = ProgressDialog.show(RetrofitActivity.this,"Menambahkan...","Tunggu...",false,false);
    }
    ...
    protected void onPostExecute(String s)   {
        ...
        try {
            ...
            Toast.makeText(RetrofitActivity.this,message + " Status "+ notif,Toast.LENGTH_LONG).show();
...
class cekIdEmployee extends AsyncTask<Void,Void,String>{
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        loading = ProgressDialog.show(RetrofitActivity.this,"Mencari data...","Waiit...",false,false);
    }
    @Override
    protected void onPostExecute(String s)   {
        super.onPostExecute(s);
...
public void onClick(DialogInterface dialog, int which) {
        ...
        Toast.makeText(RetrofitActivity.this, "Data di update! ", Toast.LENGTH_LONG).show();
...
@Override
public void onClick(DialogInterface dialog, int which) {
        Toast.makeText(RetrofitActivity.this, "Dibatalkan! " , Toast.LENGTH_LONG).show();
        // Do nothing
        dialog.dismiss();
        }
        });
...
class updateIdEmployee extends AsyncTask<Void,Void,String>{
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        loading = ProgressDialog.show(RetrofitActivity.this,"Megupdate data...","Wait...",false,false);
    }
    @Override
    protected void onPostExecute(String s)   {
        super.onPostExecute(s);
